...
def save_api_key(message):
    ...
    try:
        ...
        run_with_timeout(lambda: test_client.interactions.create(model=MODEL, input="hi"), 30)
...
@bot.callback_query_handler(func=lambda call: call.data == "rmk_all" or (call.data or "").startswith("rmk:"))
